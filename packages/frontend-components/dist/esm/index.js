...
import { ThemeContext as ThemeContext$1, keyframes } from '@emotion/react';
import ReactDOM from 'react-dom';
import { styled as styled$3, makeStyles } from '@mui/styles';
import { TextField as TextField$1, InputAdornment, IconButton as IconButton$1, Modal as Modal$1, Box as Box$2, FormControl as FormControl$1, Checkbox as Checkbox$1, FormControlLabel as FormControlLabel$1 } from '@mui/material';
...
process.env.NODE_ENV !== "production" ? {
   ...
   * @ignore
   */
  styles: propTypes.exports /* @typescript-to-proptypes-ignore */.oneOfType([propTypes.exports.array, propTypes.exports.func, propTypes.exports.number, propTypes.exports.object, propTypes.exports.string, propTypes.exports.bool]),
  /**
   * @ignore
   */
...
const useUtilityClasses$4 = (ownerState, componentName) => {
...
function createContainer(options = {}) {
  ...
  const Container = /*#__PURE__*/React.forwardRef(function Container(inProps, ref) {
    ...
    // @ts-ignore module augmentation fails if custom breakpoints are used
    const classes = useUtilityClasses$4(ownerState, componentName);
    return (
      /*#__PURE__*/
  ...
  process.env.NODE_ENV !== "production" ? Container.propTypes /* remove-proptypes */ = {
    ...
    maxWidth: propTypes.exports /* @typescript-to-proptypes-ignore */.oneOfType([propTypes.exports.oneOf(['xs', 'sm', 'md', 'lg', 'xl', false]), propTypes.exports.string]),
    sx: propTypes.exports.oneOfType([propTypes.exports.arrayOf(propTypes.exports.oneOfType([propTypes.exports.func, propTypes.exports.object, propTypes.exports.bool])), propTypes.exports.func, propTypes.exports.object])
  } : void 0;
  return Container;
}
...
const _excluded$a = ["className", "children", "columns", "container", "component", "direction", "wrap", "spacing", "rowSpacing", "columnSpacing", "disableEqualOverflow", "unstable_level"];
...
process.env.NODE_ENV !== "production" ? Grid.propTypes /* remove-proptypes */ = {
   ...
   * @default 12
   */
  columns: propTypes.exports /* @typescript-to-proptypes-ignore */.oneOfType([propTypes.exports.arrayOf(propTypes.exports.number), propTypes.exports.number, propTypes.exports.object]),
  /**
   * Defines the horizontal space between the type `item` components.
   * It overrides the value of the `spacing` prop.
   */
  columnSpacing: propTypes.exports /* @typescript-to-proptypes-ignore */.oneOfType([propTypes.exports.arrayOf(propTypes.exports.oneOfType([propTypes.exports.number, propTypes.exports.string])), propTypes.exports.number, propTypes.exports.object, propTypes.exports.string]),
  /**
   ...
   * @default 'row'
   */
  direction: propTypes.exports /* @typescript-to-proptypes-ignore */.oneOfType([propTypes.exports.oneOf(['column-reverse', 'column', 'row-reverse', 'row']), propTypes.exports.arrayOf(propTypes.exports.oneOf(['column-reverse', 'column', 'row-reverse', 'row'])), propTypes.exports.object]),
  /**
   ...
   * It overrides the value of the `spacing` prop.
   */
  rowSpacing: propTypes.exports /* @typescript-to-proptypes-ignore */.oneOfType([propTypes.exports.arrayOf(propTypes.exports.oneOfType([propTypes.exports.number, propTypes.exports.string])), propTypes.exports.number, propTypes.exports.object, propTypes.exports.string]),
  /**
   * If a number, it sets the number of columns the grid item uses.
   * It can't be greater than the total number of columns of the container (12 by default).
   * If 'auto', the grid item's width matches its content.
   ...
   * @default 0
   */
  spacing: propTypes.exports /* @typescript-to-proptypes-ignore */.oneOfType([propTypes.exports.arrayOf(propTypes.exports.oneOfType([propTypes.exports.number, propTypes.exports.string])), propTypes.exports.number, propTypes.exports.object, propTypes.exports.string]),
  /**
   * @ignore
   */
  sx: propTypes.exports.oneOfType([propTypes.exports.arrayOf(propTypes.exports.oneOfType([propTypes.exports.func, propTypes.exports.object, propTypes.exports.bool])), propTypes.exports.func, propTypes.exports.object]),
   ...
   * ```
   */
  unstable_level: propTypes.exports.number,
  /**
...
process.env.NODE_ENV !== "production" ? Stack.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  useFlexGap: propTypes.exports.bool
} : void 0;
...
var StyledButton = styled$3(Button$1)(function (_a) {
    var theme = _a.theme;
    return ({
        '&&': {
            textTransform: 'none',
...
var Button = function (props) {
    ...
    return (jsx(StyledButton, __assign({}, props, { children: label })));
};
...
var Input = function (props) {
    var _a = useState(false), isLabelShrunk = _a[0], setIsLabelShrunk = _a[1];
    ...
    var propsObj = __assign({}, props);
    delete propsObj.setValue;
    return (jsx(Controller, { name: props.name, control: props.control, defaultValue: "", rules: props.rules, render: function (_a) {
            var _b = _a.field, onChange = _b.onChange, value = _b.value, error = _a.fieldState.error;
            return (jsx(TextField$1, __assign({ value: value, onChange: function (_a) {
                    var value = _a.target.value;
                    onChange(value);
                    if (props === null || props === void 0 ? void 0 : props.setValue)
                        props.setValue(props.name, value);
                }, onFocus: onFocusFunction, onBlur: onBlurFunction, error: !!error, helperText: error ? error.message : "", variant: "outlined", fullWidth: true, type: props.passwordVisibility ? "password" : "text", sx: { marginTop: '20px',
                    '& input': {
                        color: props.mode === 'dark' ? '#fff' : 'inherit',
                    }
                }, InputLabelProps: { shrink: isLabelShrunk }, inputProps: {
                    style: {
                        border: 0, // Set border to 0 for the input element
                    },
                } }, propsObj, { InputProps: __assign({ sx: {
                        border: 'none',
                        '&:before': {
                    ...
                    ? {
                        endAdornment: (jsx(InputAdornment, __assign({ position: "end" }, { children: jsx(IconButton$1, __assign({ "aria-label": "toggle password visibility", onClick: props.changePasswordStatus }, { children: props.passwordVisibility ? jsx(default_1$1, {}) : jsx(default_1, {}) })) }))),
                    }
                    : {})) })));
        } }));
};

var iconContainerStyle = makeStyles(function () { return ({
    root: {
        marginLeft: '1px',
        cursor: 'pointer',
    }
...
process.env.NODE_ENV !== "production" ? IconButton.propTypes /* remove-proptypes */ = {
   ...
   * @default 'default'
   */
  color: propTypes.exports /* @typescript-to-proptypes-ignore */.oneOfType([propTypes.exports.oneOf(['inherit', 'default', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), propTypes.exports.string]),
  /**
   * If `true`, the component is disabled.
   * @default false
   */
...
var IconContainer = function (props) {
    ...
    var classes = iconContainerStyle();
    return (jsx(IconButton, __assign({ className: classes.root }, other, { role: 'button', "aria-label": 'Bot\u00F3n del Tema' }, { children: children })));
};

var screenBackgroundWithColorStyle = makeStyles(function (theme) { return ({
    root: {
...
var ScreenBackground = function (props) {
    var children = props.children;
    var classes = screenBackgroundWithColorStyle();
    return (jsx("div", __assign({ className: classes.root }, { children: children })));
};

var Modal = function (_a) {
    var open = _a.open, onClose = _a.onClose, children = _a.children;
    return (jsx(Modal$1, __assign({ open: open, onClose: onClose }, { children: jsx(Box$2, { children: children }) })));
};
...
var FormControl = function (props) {
    return jsx(FormControl$1, __assign({}, props));
};
...
var FormControlLabel = function (props) {
    return jsx(FormControlLabel$1, __assign({}, props));
};

export { Box, Button, Checkbox, FormControl, FormControlLabel, IconContainer, Input, Modal, ScreenBackground, TextField };
