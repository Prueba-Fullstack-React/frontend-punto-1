...
function ThemeProvider$1(props) {
  ...
  return /*#__PURE__*/require$$2.jsx(ThemeContext.Provider, {
    value: theme,
    children: children
  });
}
...
function ThemeProvider(props) {
  ...
  return /*#__PURE__*/require$$2.jsx(ThemeProvider$1, {
    theme: privateTheme,
...
function createGrid(options = {}) {
  ...
  const Grid = /*#__PURE__*/React__namespace.forwardRef(function Grid(inProps, ref) {
    ...
    let result = /*#__PURE__*/require$$2.jsx(GridRoot, _extends({
      ref: ref,
      as: component,
      ownerState: ownerState,
      className: clsx(classes.root, className)
    ...
    if (disableEqualOverflow !== undefined && disableEqualOverflow !== (overflow != null ? overflow : false)) {
      ...
      result = /*#__PURE__*/require$$2.jsx(OverflowContext.Provider, {
...
const TouchRipple = /*#__PURE__*/React__namespace.forwardRef(function TouchRipple(inProps, ref) {
  ...
  return /*#__PURE__*/require$$2.jsx(TouchRippleRoot, _extends({
    ...
    children: /*#__PURE__*/require$$2.jsx(TransitionGroup, {
      component: null,
      exit: true,
      children: ripples
    })
...
const ButtonBase = /*#__PURE__*/React__namespace.forwardRef(function ButtonBase(inProps, ref) {
  ...
  return /*#__PURE__*/require$$2.jsxs(ButtonBaseRoot, _extends({
    ...
    require$$2.jsx(TouchRipple, _extends({
      ref: handleRippleRef,
      center: centerRipple
...
var StyledButton = styles.styled(Button$1)(function (_a) {
    var theme = _a.theme;
    return ({
        '&&': {
            textTransform: 'none',
...
var Button = function (props) {
    ...
    return (require$$2.jsx(StyledButton, __assign({}, props, { children: label })));
};
...
var Input = function (props) {
    var _a = React.useState(false), isLabelShrunk = _a[0], setIsLabelShrunk = _a[1];
    ...
    return (require$$2.jsx(Controller, { name: props.name, control: props.control, defaultValue: "", rules: props.rules, render: function (_a) {
            var _b = _a.field, onChange = _b.onChange, value = _b.value, error = _a.fieldState.error;
            return (require$$2.jsx(material.TextField, __assign({ value: value, onChange: function (_a) {
                    ...
                    ? {
                        endAdornment: (require$$2.jsx(material.InputAdornment, __assign({ position: "end" }, { children: require$$2.jsx(material.IconButton, __assign({ "aria-label": "toggle password visibility", onClick: props.changePasswordStatus }, { children: props.passwordVisibility ? require$$2.jsx(default_1$1, {}) : require$$2.jsx(default_1, {}) })) }))),
                    }
                    : {})) })));
        } }));
};

var iconContainerStyle = styles.makeStyles(function () { return ({
    root: {
        marginLeft: '1px',
        cursor: 'pointer',
    }
...
var IconContainer = function (props) {
    ...
    return (require$$2.jsx(IconButton, __assign({ className: classes.root }, other, { role: 'button', "aria-label": 'Bot\u00F3n del Tema' }, { children: children })));
};

var screenBackgroundWithColorStyle = styles.makeStyles(function (theme) { return ({
    root: {
...
var ScreenBackground = function (props) {
    ...
    return (require$$2.jsx("div", __assign({ className: classes.root }, { children: children })));
};

var Modal = function (_a) {
    var open = _a.open, onClose = _a.onClose, children = _a.children;
    return (require$$2.jsx(material.Modal, __assign({ open: open, onClose: onClose }, { children: require$$2.jsx(material.Box, { children: children }) })));
};

var Box = function (props) {
    return require$$2.jsx(material.Box, __assign({}, props));
};

var TextField = function (props) {
    return require$$2.jsx(material.TextField, __assign({}, props));
};

var FormControl = function (props) {
    return require$$2.jsx(material.FormControl, __assign({}, props));
};

var Checkbox = function (props) {
    return require$$2.jsx(material.Checkbox, __assign({}, props));
};

var FormControlLabel = function (props) {
    return require$$2.jsx(material.FormControlLabel, __assign({}, props));
};
...
exports.Input = Input;
exports.Modal = Modal;
exports.ScreenBackground = ScreenBackground;
